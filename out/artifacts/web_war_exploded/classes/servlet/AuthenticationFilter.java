...
@WebFilter(servletNames = {  "FullGameInfo","CreateGame"})
public class AuthenticationFilter implements Filter {
    ...
    private boolean userAlreadyLoggedIn(ServletRequest servletRequest) {
        HttpServletRequest httpRequest = (HttpServletRequest) servletRequest;

        return httpRequest.getSession().getAttribute("currentUser") != null;
    }
